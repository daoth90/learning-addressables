...
namespace Addressables_Test {
  public class LoadSubAsset_SpriteInSpriteSheet : MonoBehaviour {
    private string key = "hero-idle[hero-idle_1]";
    private AsyncOperationHandle<Sprite> opHandle;
    private Watch watch;
    ...
    private IEnumerator Load() {
      opHandle = Addressables.LoadAssetAsync<Sprite>(key);
